...
INSERT INTO `test`.`membershiptypes` (`name`, `annexTypeId`, `suscriptionAmmount`, `createdAt`, `updatedAt`) VALUES ('100$', '1', '100', '2019-02-13 04:40:29', '2019-02-13 04:40:29');
INSERT INTO `test`.`membershiptypes` (`name`, `annexTypeId`, `suscriptionAmmount`, `createdAt`, `updatedAt`) VALUES ('500$', '1', '500', '2019-02-13 04:40:29', '2019-02-13 04:40:29');
